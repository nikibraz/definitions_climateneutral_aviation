...
plots_final = True # or False
plots_SI = True # or True to produce SI Figures
...
if output_xlsx == True:
    ...
    with pd.ExcelWriter('Outputs/output_rawdata_T.xlsx', datetime_format="YYYY-MM-DD") as writer:
        ...
        summary_T_tech2_allmetrics.to_excel(writer, sheet_name='T_2100_degreeC_allmetrics_Eairplanes')
    ...
    with pd.ExcelWriter('Outputs/output_rawdata_CDR.xlsx', datetime_format="YYYY-MM-DD") as writer:
        ...
        positive_cumulativeCDR_summary_alltechs.to_excel(writer, sheet_name='positive_cumulativeCDR_2100_MtCO2')
        negative_cumulativeCDR_summary_alltechs.to_excel(writer, sheet_name='negative_cumulativeCDR_2100_MtCO2')
